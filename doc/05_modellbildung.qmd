...
Der Vorteil dieses Ansatzes liegt darin, dass den Federn anstelle der elastischen Beziehung, auch nicht-lineare Federbeziehungen hinterlegt werden können. Dadurch können nicht-lineare Bieglinien numerisch approximiert werden. Die Erweiterung des Modells ist schematisch in der @fig-allg_gedankenexp illustriert.
...
![Bieglinie des einfachen Balkens mit nicht-linearen Federn](../imgs/allg_stat_system_def_nl.svg){#fig-allg_stat_system_def_nl}

Das Gedankenexperiment lässt sich mit der Erkenntnis abschliessen, dass das System an sich nicht komplex ist. Die qualität der gewünschten Resultate jedoch einzig von der Bestimmung der Federsteifigkeiten abhängt.
...
Modelliert wird in AxisVM-X7 nicht mit einer Feder, sondern mit einem Stabgelenk. Das Stabgelenk ist im Gegensatz zur Feder unendlich klein, was die Präzision des Systems verbessert. Zudem reduziert sich der Modellierungsaufwand. Die Federn werden fortan mit Stabgelenken beschrieben.
