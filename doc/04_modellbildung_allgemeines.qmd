...
Dieses Kapitel soll die Modellbildung in groben Zügen beschreiben. Dazu dienen ein Gedankenexperiment, ein allgemein gültiges Berechnungsschema und die Systemmodellbildung.
...
![Biegelinie des adaptieren, einfachen Balkens mit nicht-linearen Drehfedern, ergänzt mit elastischer Biegelinie](../imgs/allg_stat_system_def_nl.svg){#fig-allg_stat_system_def_nl}
...
Die Systemmodellbildung ist mit dem einleitenden Gedankenexperiment in ihren Grundzügen aufgezeigt. Der folgende Abschnitt beschreibt die Einzelheiten. Dabei ist die Querschnittsmodellbildung ausgeklammert. Diese ist in den folgenden Kapiteln für Balken und Platten gesondert beschrieben.
...
Eine solche Feststellung ist jedoch von kleinem praktischem Nutzen. Umsetzbar ist hingegen eine Sensitivitätsanalyse der Elementlänge. Dazu ist das Modell mit einer Variation der Elementlänge zu berechnen, um den Einfluss dieser zu quantifizieren.
