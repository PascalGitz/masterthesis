...
&M_x = T = \int_A \left(z \cdot \tau_yx - y \cdot \tau_zx\right) dA
\end{aligned}
$${#eq-sg_schub_balken}
...
Die Torsionssteifigkeit dient in dieser Arbeit einzig der Abbildung von Drillmomenten im Trägerrost bei der Nachrechnung von Plattentragwerken.
