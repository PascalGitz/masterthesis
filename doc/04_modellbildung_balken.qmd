...
Die Querschnittsmodellbildung startet beim Beschrieb der allgemeinen Grössen am Stabquerschnitt. Gefolgt von der Bestimmung der Biegesteifigkeit am Balkenquerschnitt. Nach der Bestimmung der Biegesteifigkeit ist gezeigt, wie diese auf die Gelenke zu übertragen ist. Die Definition des Abbruchkriteriums bildet den Abschluss.
...
Die Zugversteifung basiert auf dem Zuggurtmodell. Als Übersicht sind folgend die Grundzüge des Zuggurtmodells aufgezeigt. Der Abschnitt soll die Zusammenhänge erläutern und die verwendeten Begriffe klären.
...
Das Zuggurtmodell vereinfacht die Tragwirkung und setzt eine abgetreppte ideale Verbundschubspannungs-Schlupf-Beziehung voraus, dargestellt in @fig-allg_schubspann_schlupf.
...
Unter dieser Voraussetzung lässt sich die Verdrehung durch die Multiplikation der Krümmung mit der Einzugslänge bestimmen, es gilt die @eq-phi_to_chi_konst.
