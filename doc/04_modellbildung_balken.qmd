...
Unter der Voraussetzung des elastischen Verhaltens des Betons bestimmt die @eq-gerissene_steifigkeit_balken die Druckzonenhöhe $x$, das Fliessmoment $M_y$ und die gerissene Biegesteifigkeit $EI_{II}$. 
...
### Von der Krümmung zur Verdrehung
...
Abschliessend ist die Ermittlung der einzelnen Rissverdrehungen zu klären. Diese entsprechen der relativen Gelenkrotationen, welche in @fig-allg_relative_gelenkrot illustriert sind. Diese lassen sich als Resultat in AxisVM-X7 ausgeben. 
