...
Das vorangegangene Kapitel hat die Querschnittmodellbildung aussenvor gelassen. Das Ziel dieses Kapitels ist es, die Querschnittmodellbildung für Stabtragwerke aufzuzeigen. 

## Querschnittmodellbildung

Die Querschnittmodellbildung beschreibt die Grössen am Stabquerschnitt, zeigt die Transformation vom Querschnitt zum Stabgelenk aufZuggurtmodell, die Ermittlung der Biegesteifigkeit und das Abbruchkriterium.

### Abgrenzung des Stabs

Ein Stab weist die Schnittgrössen der gemäss der @fig-allg_balken_sg a) auf, dazu sind die aus den Schnittgrössen hervorgerufenen elementaren Verformungen in der @fig-allg_balken_sg b) gezeigt.
...
Gekoppelt sind die Grössen über die Biegesteifigkeit, aufgezeigt in der @eq-biegesteifigkeit.
...
Das Ziel ist es die Momentenfunktion gemäss der @def-gelenkfunktionen_raum zu ermitteln. Dazu ist eine Momenten-Krümmungs-Beziehung am Querschnitt zu definieren.
...
Es gilt, dass die Bewehrung lediglich Kräfte in der Stabrichtung übertragen, sowie gelten die folgenden Hypothesen nach Bernoulli-Navier:
...
### Von der Querschnittkrümmung zur Gelenkverdrehung

Im Beschrieb der Feder wurde die Einzugslänge eingeführt mit dem Vermerk, dass die Feder das Systemverhalten innerhalb der Einzugslänge definiert. Bezogen auf das Biegeverhalten 
